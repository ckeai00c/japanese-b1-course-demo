...
框架统一处理：场景背景、NPC 会话气泡、自动播放、常速/慢速播放、chunk 点击音频、答对/答错音效、错误标红回弹、正确标绿、完成后复现原内容、全日文注音（假名/罗马音）、句子标点固定显示和口语即时判题。词义、单词 chunk 和词组 chunk 页面都会展示对应会话句；用户在任意口语题点击“不做口语题”后，本轮全部口语题都会切换成各自句子的 chunk 拼写题。
